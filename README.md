...
- Languages and frameworks: JavaScript, TypeScript, Go, Elixir, Phoenix, Ruby, Rails, PHP, Laravel, Symfony, Java, Maven, Gradle, and Spring Boot.
- Package and task tooling: npm, pnpm, Yarn, Bun, Mix, Bundler, Rake, Composer, Maven, Gradle, and Make.
