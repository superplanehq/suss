...
- Languages and frameworks: JavaScript, TypeScript, Go, Rust, Elixir, Phoenix, Ruby, Rails, PHP, Laravel, and Symfony.
- Package and task tooling: npm, pnpm, Yarn, Bun, Cargo, Mix, Bundler, Rake, Composer, and Make.
